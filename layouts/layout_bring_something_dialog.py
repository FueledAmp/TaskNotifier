...
###########################################################################
## Class BringSomethingDialog
###########################################################################

class BringSomethingDialog(wx.Dialog):

    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"Bring Something - Task Notifier", pos=wx.DefaultPosition,
        ...
        self.m_staticText8 = wx.StaticText(self, wx.ID_ANY, u"What item do you want him to bring?", wx.DefaultPosition,
                                           wx.DefaultSize, 0)
        ...
        self.m_staticText3 = wx.StaticText(self, wx.ID_ANY, u"Item Name:", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.textCtrlItemName = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0)
        self.textCtrlItemName.SetForegroundColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BTNTEXT))

        bSizer9.Add(self.textCtrlItemName, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
